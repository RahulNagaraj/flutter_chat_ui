...
final User currentUser =
    User(id: 0, name: 'Current User', avatarUrl: 'assets/images/steven.jpg');

final User greg =
    User(id: 1, name: 'Greg', avatarUrl: 'assets/images/greg.jpg');

final User james =
    User(id: 2, name: 'James', avatarUrl: 'assets/images/james.jpg');

final User john =
    User(id: 3, name: 'John', avatarUrl: 'assets/images/john.jpg');
